...
class Product extends \App\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'picture', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'price', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'reduction'];
        }
     ...
     * {@inheritDoc}
     */
    public function setReference(int $reference): \App\Entity\Product
    {
     ...
     * {@inheritDoc}
     */
    public function setReduction(?int $reduction): \App\Entity\Product
    {
